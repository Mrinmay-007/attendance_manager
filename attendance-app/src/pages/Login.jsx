// import React from "react"; // not needed - Vite's automatic JSX runtime doesn't require it, and it was never referenced directly
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    let endpoint = "";
    endpoint = `${API_BASE || "http://localhost:8000"}/auth/login`;
